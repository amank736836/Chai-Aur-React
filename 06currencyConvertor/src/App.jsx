  ...
  return (
    ...
    >
        <div className="w-full relative">
            <img src='https://images.pexels.com/photos/9660/business-money-pink-coins.jpg?auto=compress&cs=tinysrgb&w=600'
                className="absolute translate-x-1/4 -translate-y-1/2 border-3xl px-2 py-0.5"
                ></img>

            <div className="absolute translate-x-full -translate-y-1/2 max-w-4xl mx-auto border border-gray-60 rounded-lg p-8 backdrop-blur-sm bg-blue-600/30">
                 <h1 className=' w-full mx-auto text-center text-white text-6xl pb-14'>🤑💵Currency app with AK🤗</h1>
                <form
                    // onSubmit={(e) => {
                    //     e.preventDefault();
                    //     // convert();
